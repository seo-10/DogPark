...
<body>
 <%ArrayList<DogjarangDto> dto = (ArrayList<DogjarangDto>)request.getAttribute("articleList"); %>
	...
	<form name="form" method="post" action="dj_updateprocess.bo?code_no=<%=dto.get(0).getCode_no()%>">
		<!-- 로그아웃 다이얼로그 -->
...
<div name="ht_read_writer" id="dj_read_writer"><%out.println(id);%></div>
<input type="submit" value="수정 완료" id="dj_text_update2"/>
</aside>
  <div>
